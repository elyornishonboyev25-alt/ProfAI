...
export default function AuthShowcasePanel({ quote = 'Your university journey continues here.' }: { quote?: string }) {
  ...
  return (
    <aside className="auth-showcase relative hidden min-h-[720px] overflow-hidden rounded-[2.5rem] bg-[#090d1a] p-9 text-white shadow-[0_34px_90px_rgba(15,23,42,.34)] lg:flex lg:flex-col lg:justify-between xl:p-11">
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(6,9,20,.58)_0%,rgba(9,13,26,.84)_52%,rgba(18,7,14,.98)_100%),linear-gradient(118deg,rgba(127,29,29,.7),transparent_58%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_15%,rgba(251,113,133,.25),transparent_30%),radial-gradient(circle_at_18%_76%,rgba(239,68,68,.18),transparent_34%)]" />
      <div className="pointer-events-none absolute inset-x-10 top-0 h-px bg-gradient-to-r from-transparent via-red-300/80 to-transparent" />

      <div className="relative flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-white/10 shadow-[0_14px_34px_rgba(239,68,68,.28)] backdrop-blur-xl">
            <BrandMark size={38} />
          </span>
          <div>
            <p className="text-sm font-black tracking-tight">Prof<span className="text-red-400">AI</span></p>
      ...
      <div className="relative py-8">
        <motion.span
          ...
          className="inline-flex items-center gap-2 rounded-full border border-red-300/20 bg-red-400/10 px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.18em] text-red-200 backdrop-blur-xl"
        >
        ...
        <div className="relative mt-8 overflow-hidden rounded-[1.8rem] border border-white/15 bg-white/[.08] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,.12),0_24px_48px_rgba(0,0,0,.24)] backdrop-blur-2xl">
          ...
          <div className="mb-4 flex items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-red-200">Your live route</p>
          ...
          <div className="relative grid grid-cols-3 gap-3">
            <div className="absolute left-[16%] right-[16%] top-5 h-px bg-gradient-to-r from-red-400/60 via-orange-300/70 to-emerald-300/60" />

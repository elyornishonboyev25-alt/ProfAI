...
export function BrandMark({ size = 44, className }: BrandMarkProps) {
  ...
  return (
    <span
      ...
      aria-hidden="true"
    >
      {/* Glossy world-map cap used throughout the ProfAI identity. */}
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
        <defs>
          <linearGradient id={capId} x1="10" y1="9" x2="54" y2="36" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#e7686d" />
            <stop offset="47%" stopColor="#a52d3a" />
            <stop offset="100%" stopColor="#222a3a" />
          </linearGradient>
          <linearGradient id={baseId} x1="18" y1="29" x2="46" y2="48" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#d2363e" />
            <stop offset="48%" stopColor="#942330" />
            <stop offset="100%" stopColor="#202839" />
          </linearGradient>
          <linearGradient id={tasselId} x1="46" y1="22" x2="56" y2="46" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#4b3448" />
            <stop offset="100%" stopColor="#25293a" />
          </linearGradient>
        ...
        <path
          ...
          fill={`url(#${baseId})`}
        />
        <path d="M16.6 26.8 32 34.1 47.4 26.8" stroke="#fca5aa" strokeOpacity="0.65" strokeWidth="1.1" fill="none" />

        {/* Mortarboard (top-down, in perspective) */}
        <path d="M32 8.4 59.4 21.4 32 34.4 4.6 21.4Z" fill={`url(#${capId})`} />
        <path d="M32 8.4 59.4 21.4 32 34.4 4.6 21.4Z" stroke="#f6c9cd" strokeOpacity="0.8" strokeWidth="0.9" />
        <path d="M8 21.1 31 10.3 54 21.1" stroke="white" strokeOpacity=".27" strokeWidth=".8" />

        {/* Deep polished rim gives the cap its dimensional edge. */}
        <path d="M4.6 21.4 32 34.4l27.4-13v3.1L32 37.6 4.6 24.5Z" fill="#202839" />
        <path d="M5.2 24.1 32 36.9l26.8-12.8" stroke="#f9b1b7" strokeOpacity=".75" strokeWidth=".8" />

        {/* World map on the board — simplified continents (study abroad) */}
        <g className="profai-brand-world-map" clipPath={`url(#${boardClipId})`} fill="#ffd3d5" fillOpacity="0.93">
        ...
        />
        {/* Centre button */}
        <circle cx="32" cy="21.4" r="2.3" fill="#ffd3d5" />
        <circle cx="32" cy="21.4" r="1" fill="#822b3a" />

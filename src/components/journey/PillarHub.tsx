...
const TONES: Record<
  PillarHubCard['tone'],
  { eyebrow: string; button: string; glow: string; detail: string }
> = {
  red: {
    ...
    <main className="workspace-page relative min-h-screen overflow-hidden px-3 py-5 sm:px-6 sm:py-6 lg:px-10">
      ...
      <div className="relative z-10 mx-auto min-w-0 w-full max-w-[112rem]">
        ...
        <motion.header
          ...
          className={cn(
            'relative mx-auto min-w-0 w-full max-w-6xl overflow-hidden px-3 pb-6 text-center sm:pb-7',
        ...
        >
          ...
          <h1 className="mt-3 max-w-full break-words text-[clamp(2.15rem,6.7vw,4.75rem)] font-black leading-[.94] tracking-[-.055em] text-[#070a18] [overflow-wrap:anywhere] sm:leading-[.9] sm:tracking-[-.06em]">
            {title}
          </h1>
            ...
            return (
              ...
              >
                ...
                <div className="relative flex h-full min-w-0 flex-col">
                  ...
                  <p className={cn('mt-4 text-[10px] font-black uppercase tracking-[0.22em] sm:text-xs', tone.eyebrow)}>{card.eyebrow}</p>
                  ...
                  <button
                    ...
                    className={cn(
                      'mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl px-5 text-sm font-black text-white transition duration-300 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-200/70 sm:w-auto sm:self-start',
                      tone.button,
                    )}

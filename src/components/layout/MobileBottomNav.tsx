...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 border-t border-red-100 bg-white/98 pb-[max(env(safe-area-inset-bottom),0.4rem)] pt-1.5 shadow-[0_-10px_30px_rgba(127,29,29,0.09)] lg:hidden"
    >

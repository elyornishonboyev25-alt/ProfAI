    ...
    <div className={`premium-feature-lock relative isolate h-full overflow-hidden rounded-[1.5rem] ${className}`}>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center bg-[linear-gradient(145deg,rgba(255,255,255,.38),rgba(255,247,237,.64))] p-3 backdrop-blur-[2px]">
        <motion.button
          ...
          className={`group relative overflow-hidden border border-white/90 bg-white/88 text-left shadow-[0_18px_44px_rgba(30,64,175,.18)] backdrop-blur-2xl ${
        ...
        >
          ...
          <span className="relative flex items-start gap-3">
            <span className={`flex shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 via-orange-500 to-blue-500 text-white shadow-[0_10px_24px_rgba(245,158,11,.34)] ${compact ? 'h-9 w-9' : 'h-11 w-11'}`}>

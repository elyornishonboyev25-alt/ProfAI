    ...
    <AnimatePresence>
      {open ? (
        ...
        >
          ...
          >
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-red-950 via-red-500 to-orange-400" />
            <div className="pointer-events-none absolute -right-16 -top-16 h-44 w-44 rounded-full bg-red-200/50 blur-3xl" />

            <div className="relative p-6 sm:p-8">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-red-800 text-white shadow-[0_16px_34px_rgba(220,38,38,.32)]">
                    <ShieldAlert className="h-5 w-5" />
                  </span>
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.18em] text-red-600">Permanent action</p>
              ...
              <div className="mt-5 rounded-2xl border border-red-200 bg-gradient-to-r from-red-50 to-orange-50/70 p-4">
                <p className="flex items-center gap-2 text-sm font-black text-red-800">
                  <AlertTriangle className="h-4 w-4" /> This cannot be undone
                </p>
                <p className="mt-1.5 text-xs leading-5 text-red-900/70">
                ...
                <label className="block">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      spellCheck={false}
                      placeholder={email}
                      className="input h-12 rounded-2xl border-red-100 bg-white pl-11 text-sm font-semibold"
                    />
                  </div>
                </label>
                <label className="block">
                  <span className="mb-1.5 block text-xs font-black text-slate-700">
                    Type <span className="rounded bg-red-100 px-1.5 py-0.5 font-mono text-red-700">DELETE</span> to continue
                  </span>
                  <input
                    value={phrase}
                    ...
                    maxLength={6}
                    placeholder="DELETE"
                    className="input h-12 rounded-2xl border-red-100 bg-white font-mono text-sm font-black tracking-[0.16em]"
                  />
                </label>
              </div>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                ...
                <button
                  ...
                  disabled={!canDelete}
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-red-800 via-red-700 to-red-600 px-4 text-sm font-black text-white shadow-[0_14px_30px_rgba(185,28,28,.3)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(185,28,28,.4)] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:translate-y-0"
                >

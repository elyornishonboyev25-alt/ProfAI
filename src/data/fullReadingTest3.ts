...
const passage1: Section = {
  id: 'manatees-p1',
  title: 'Reading Passage 1: Manatees',
  paragraphs: [
    {
      label: 'A',
      content:
  ...
  questions: [
    {
      ...
      text: 'look similar to dugongs, but with a differently shaped ______',
      correctAnswer: 'tail',
    ...
    },
    {
      ...
      number: 2,
      type: 'note-completion',
      text: 'need to use their ______ to help turn their bodies around in order to look sideways',
    ...
    },
    {
      ...
      number: 4,
      type: 'note-completion',
      text: 'eat mainly aquatic vegetation, such as ______',
    ...
    },
    {
      ...
      number: 5,
      type: 'note-completion',
      text: 'grasp and pull up plants with their ______',
      correctAnswer: 'lips',
    ...
    },
    {
      ...
      number: 6,
      type: 'note-completion',
      text: 'may regulate the ______ of their bodies by using muscles of diaphragm to store air internally',
...
const passage2: Section = {
  id: 'procrastination-p2',
  title: 'Reading Passage 2: Procrastination',
  paragraphs: [
    {
      label: 'A',
      content:
  ...
  questions: [
    {
      id: 'procrastination-q14',
      number: 14,
      type: 'matching-information',
      groupTitle: 'Questions 14-16',
      instruction:
        'Reading Passage 2 has six paragraphs. Which paragraph contains the following information?',
    ...
    {
      id: 'procrastination-q17',
      number: 17,
      type: 'summary-completion',
      groupTitle: 'Questions 17-22',
      instruction: 'Complete the summary below. Choose ONE WORD ONLY from the passage for each answer.',
      text: 'Many people think that procrastination is the result of ______.',
      correctAnswer: 'laziness',
      location: 'Paragraph B',
    },
    {
      id: 'procrastination-q18',
      number: 18,
      type: 'summary-completion',
      text:
        'The tasks we are most likely to put off are those that could damage our self-esteem or cause us to feel ______ when we think about them.',
      correctAnswer: 'anxious',
      location: 'Paragraph B',
    },
    {
      id: 'procrastination-q19',
      number: 19,
      type: 'summary-completion',
      text:
        'Research comparing chronic procrastinators with other people even found differences in the brain regions associated with regulating emotions and identifying ______.',
      correctAnswer: 'threats',
      location: 'Paragraph B',
    },
    {
      id: 'procrastination-q20',
      number: 20,
      type: 'summary-completion',
      text: 'Getting ready to take ______ might be a typical example of one such task.',
      correctAnswer: 'exams',
      location: 'Paragraph C',
    },
    {
      id: 'procrastination-q21',
      number: 21,
      type: 'summary-completion',
      text: 'People who are likely to procrastinate tend to be either ______ or those with low self-esteem.',
      correctAnswer: 'perfectionists',
      location: 'Paragraph C',
    },
    {
      id: 'procrastination-q22',
      number: 22,
      type: 'summary-completion',
      text:
        "Procrastination is only a short-term measure for managing emotions. It's often followed by a feeling of ______, which worsens our mood and leads to more procrastination.",
      correctAnswer: 'guilt',
      location: 'Paragraph C',
    },
    {
      id: 'procrastination-q23',
      number: 23,
      type: 'five-true-statements',
      groupTitle: 'Questions 23-24',
      instruction:
        'Choose TWO correct answers. Which TWO comparisons between employees who often procrastinate and those who do not are mentioned in the text?',
    ...
    {
      id: 'procrastination-q25',
      number: 25,
      type: 'five-true-statements',
      groupTitle: 'Questions 25-26',
      instruction:
        'Choose TWO correct answers. Which TWO recommendations for getting out of a cycle of procrastination does the writer give?',
      text: 'Select TWO options.',
      options: [
...
const passage3: Section = {
  id: 'robot-umpires-p3',
  title: 'Reading Passage 3: Invasion of the Robot Umpires',
  paragraphs: [
    {
      label: 'A',
      content:
  ...
  questions: [
    ...
    },
    {
      ...
      text:
        'Even after ABS was developed, MLB still wanted human umpires to shout out decisions as they had in their previous model.\n' +
        "The umpire's job had, at one time, required a personal decision about whether a ball was a strike.\n" +
        "A ball is considered a strike when the batter does not hit it and it crosses through a zone extending approximately from the batter's knee to his chest.\n" +
        'In the past, arguments over strike calls were not uncommon, but today everyone accepts the complete ban on pushing or shoving the umpire.\n' +
        'One difference, however, is that during the first game DeJesus used ABS, strike calls were met with no reaction.',
      options: [
        'pitch boundary',
        'numerous disputes',
        'team tactics',
      ...
      correctAnswer: ['former roles', 'subjective assessment', 'perceived area', 'numerous disputes', 'total silence'],
      location: 'Paragraphs B-C',
    },
    {
      id: 'robot-q38',
      number: 38,
      ...
      instruction: 'Choose the correct answer. What does the writer suggest about ABS in the fifth paragraph?',
    ...
    },
    {
      ...
      instruction: 'Choose the correct answer. Morgan Sword says that the introduction of ABS',
      text: 'Select one option.',
      options: [
    ...
    },
    {
      ...
      instruction: 'Choose the correct answer. Why does the writer include the views of Noe and Russo?',
      text: 'Select one option.',
      options: [
...
export const fullReadingTest3: IELTSTest = {
  id: 'ielts-reading-full-vol3',

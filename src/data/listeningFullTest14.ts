...
const part3: Section = {
  ...
  groups: [
    { range: 'Questions 21 - 26', instruction: 'Label the diagram below. Choose SIX answers from the box and write the correct letter, A-I, next to questions 21-26.', blocks: [
      ...
      { kind: 'image', src: '/images/ielts-listening-test14-education-house.jpg', alt: 'Education House diagram: cooling tower (21) at the left of the roof, weather station (22) at the right of the roof, shower tower (23) on the right wall, tank (24) in the basement, balcony (25) below the light shelf and windows (26) above it. Timber shutters, light shelf, basement, trees, arrows and all six original numbered spaces are retained.' },

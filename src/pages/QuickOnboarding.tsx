...
export default function QuickOnboarding() {
  ...
  const [minutes, setMinutes] = useState(previous?.dailyHours ? Math.max(60, Math.round(previous.dailyHours) * 60) : 60)

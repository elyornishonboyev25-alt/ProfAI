...
import { SAT_TEST_CATALOG } from '@/features/sat/catalog'
...
export default function SAT() {
  ...
  const completed = attempts.filter(item=>item.attempt?.status==='submitted')
  const scores = completed.map(item=>scoreSATModules(item.test.modules,item.attempt!.answers).midpoint)
